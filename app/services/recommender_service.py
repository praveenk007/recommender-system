...
def create_model_v2(mongo, request_json):
    ...
    train_data_grouped = similarity_reco.build_correlation(train_data, reco_meta['user_field'], reco_meta['item_field'], reco_meta['features'][0]['id'], reco_meta['features'][0]['weight'])
...
def recommend_similar(mongo, user_id):
